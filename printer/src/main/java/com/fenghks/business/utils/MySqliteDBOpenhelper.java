...
public class MySqliteDBOpenhelper extends SQLiteOpenHelper {
     ...
     * @param <T>
     */
    public static <T> boolean insert(String tableName, T entity) {
     ...
     * @param <T>
     */
    public static <T> boolean insert(String tableName, List<T> entities) {
        SQLiteDatabase db = INSTANCE.getWritableDatabase();
        db.beginTransaction();
        try {
            ContentValues values = new ContentValues();
     ...
     * @param <T>
     */
    public static <T> boolean update(String tableName, T entity, String whereClause, String[] whereArgs) {
        SQLiteDatabase db = INSTANCE.getWritableDatabase();
        db.beginTransaction();
        try {
            ContentValues values = new ContentValues();
     ...
     * @param tableName
     */
    public static boolean deleteFrom(String tableName) {
        SQLiteDatabase db = INSTANCE.getWritableDatabase();
        db.beginTransaction();
        try {
    ...
    public static boolean delete(String tableName, String whereClause, String[] whereArgs) {
        SQLiteDatabase db = INSTANCE.getWritableDatabase();
        db.beginTransaction();
        try {
