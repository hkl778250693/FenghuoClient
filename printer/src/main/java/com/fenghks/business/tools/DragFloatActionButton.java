...
import com.fenghks.business.utils.ScreenUtil;
...
public class DragFloatActionButton extends FloatingActionButton {
    ...
    private void init(){
        screenWidth= ScreenUtil.getScreenWidth((Activity)getContext());
        screenWidthHalf=screenWidth/2;
        screenHeight=ScreenUtil.getScreenHeight((Activity)getContext());
        statusHeight= ScreenUtil.getScreenStatusBarHeight((Activity) getContext());
    }
