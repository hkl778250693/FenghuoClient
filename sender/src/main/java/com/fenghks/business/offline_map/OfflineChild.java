package com.fenghks.business.offline_map;
...
public class OfflineChild implements OnClickListener, OnLongClickListener {
	...
	private void displayDefault() {
		...
		mDownloadImage.setImageResource(R.drawable.ic_cloud_download_24dp);
	}
	...
	private void displayWaitingStatus(int completeCode) {
		mDownloadProgress.setVisibility(View.VISIBLE);
		mDownloadImage.setVisibility(View.VISIBLE);
		mDownloadImage.setImageResource(R.drawable.ic_play_24dp);
	...
	private void displyaLoadingStatus(int completeCode) {
		...
		mDownloadImage.setVisibility(View.VISIBLE);
		mDownloadImage.setImageResource(R.drawable.ic_pause_24dp);
